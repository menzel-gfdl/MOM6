...
subroutine register_barotropic_restarts(HI, GV, G, param_file, CS, restart_CS)
  ...
  vd(3) = var_desc("vbtav","m s-1","Time mean barotropic meridional velocity",&
                hor_grid='v', z_grid='1')
  call register_restart_field(CS%ubtav, vd(2), .false., G, restart_CS)
  call register_restart_field(CS%vbtav, vd(3), .false., G, restart_CS)
  ...
  vd(3) = var_desc("vbt_IC", "m s-1", &
              ...
              hor_grid='v', z_grid='1')
  call register_restart_field(CS%ubt_IC, vd(2), .false., G, restart_CS)
  call register_restart_field(CS%vbt_IC, vd(3), .false., G, restart_CS)
  ...
  call register_restart_field(CS%uhbt_IC, vd(2), .false., G, restart_CS)
  call register_restart_field(CS%vhbt_IC, vd(3), .false., G, restart_CS)
