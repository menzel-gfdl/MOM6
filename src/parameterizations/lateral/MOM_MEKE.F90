...
! Allocate memory
  ...
  call register_restart_field(MEKE%MEKE, vd%name, .false., G, restart_CS)
  ...
  if (MEKE_KhCoeff>=0.) then
    ...
    call register_restart_field(MEKE%Kh, vd%name, .false., G, restart_CS)
  endif
  ...
  if (MEKE_viscCoeff/=0.) then
    ...
    call register_restart_field(MEKE%Ku, vd%name, .false., G, restart_CS)
  endif
